    ...
    <>
      ...
      <main className="min-h-screen bg-background pt-20 sm:pt-16">
        ...
        <Button
          ...
          size="lg"
          className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 z-50 rounded-full w-12 h-12 sm:w-14 sm:h-14 shadow-2xl hover:shadow-primary/50 transition-all duration-300 group bg-primary hover:bg-primary/90"
        >
          <div className="flex flex-col items-center">
            <Award className="w-5 h-5 sm:w-6 sm:h-6" />
            <ArrowDown className="w-3 h-3 sm:w-4 sm:h-4 -mt-1 group-hover:translate-y-1 transition-transform" />
          </div>
        </Button>

        {/* Certificate Highlights Section */}
        <section id="certificate-section" className="py-10 sm:py-16 px-4 sm:px-6 scroll-mt-16">
          <div className="container mx-auto max-w-6xl">
            <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-gradient-to-br from-primary/5 via-background to-primary/5 p-5 sm:p-8 md:p-12 border-2 border-primary/20">
              <div className="absolute inset-0 bg-grid-white/10 [mask-image:radial-gradient(white,transparent_85%)]" />
              
              <div className="relative">
                <div className="text-center mb-8 sm:mb-12">
                  <div className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                    <div className="hidden sm:block h-1 w-8 bg-primary rounded-full" />
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-primary" />
                    <h2 className="text-xl sm:text-3xl md:text-5xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent py-1 sm:py-2 leading-tight">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card className="border-2 hover:border-primary/50 transition-all duration-300 group hover:shadow-2xl hover:shadow-primary/10 bg-card/50 backdrop-blur-sm">
                      <CardContent className="p-5 sm:p-8">
                        <div className="mb-4 sm:mb-6 inline-flex p-3 sm:p-4 rounded-2xl bg-gradient-to-br from-primary/10 to-primary/5 group-hover:from-primary/20 group-hover:to-primary/10 transition-all shadow-lg">
